...
- 💻 &nbsp; Python | JavaBasics  
- 🌐 &nbsp; HTML | CSS 
- 🔧 &nbsp; Google Collab | Jupyter | Visual Studio code  | Android Studio|IntelliJ
<ul> <li>I have a passion for learning and sharing my knowledge with others as publicly as possible</li>
      <li> Learning one new thing everyday</li>
</ul>
<dl>
  <dt>connect with me: </dt>
   <dt>Linkedin-https://www.linkedin.com/in/kiruthiga-ravi-127140253</dt> 
</dl>
